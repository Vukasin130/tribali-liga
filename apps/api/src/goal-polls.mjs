...
export async function getCurrentGoalPoll(user) {
...
export async function getGoalPoll(id, user) {
...
export async function createGoalPoll(payload, actor) {
...
export async function updateGoalPoll(id, payload, actor) {
...
export async function setGoalPollStatus(id, payload, actor) {
...
export async function finishGoalPoll(id, payload, actor) {
  ...
  if (!totals.options.some((option) => option.id === winnerOptionId)) {
...
export async function voteGoalPoll(id, payload, user) {
...
export async function getGoalPollStats(id) {
...
async function closePollIfExpired(id) {
  const totals = await getPollTotals(id);
...
async function getPollTotals(id) {
...
function normalizePoll(row, options, userVote) {
...
function leadersFromOptions(options) {
