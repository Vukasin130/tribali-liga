...
export async function syncFantasyPlayerPool(competitionId, actor) {
...
export async function listFantasyPlayerPool(competitionId, filters = {}) {
  const params = [requiredText(competitionId, "Takmicenje je obavezno.")];
...
export async function activateCompetitionSeason(competitionId, payload = {}, actor) {
  const result = await transaction(async (client) => {
...
async function getLeaders(competitionId, category) {
